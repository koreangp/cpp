...
/*   Updated: 2025/02/10 17:57:27 by pscala           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap() : ClapTrap()
{
	...
	_EnergyPoints = 50;
	_AttackDamage = 20;
	std::cout << BOLD << GREEN << "ScavTrap default constructor called : " << _Name << " created !" << RESET << std::endl;
}

ScavTrap::ScavTrap(std::string name) : ClapTrap(name)
{
	std::cout << BOLD << BLUE << "ScavTrap surcharged constructor called : " << _Name << " created !" << RESET << std::endl;
	_HitPoints = 100;
	_EnergyPoints = 50;
	_AttackDamage = 20;
}
