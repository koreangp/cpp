...
/*   Updated: 2025/02/10 17:12:50 by pscala           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : _Name("JoJo"), _HitPoints(10), _EnergyPoints(10),
	_AttackDamage(0)
{
	std::cout << BOLD << GREEN << "ClapTrap default constructor called" << _Name << ": created !" << RESET << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _Name(name), _HitPoints(10),
	_EnergyPoints(10), _AttackDamage(0)
{
	std::cout << BOLD << BLUE << "ClapTrap surcharged constructor called" << _Name << ": created !" << RESET << std::endl;
}
