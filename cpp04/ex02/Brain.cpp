...
/*   Updated: 2025/03/13 10:32:59 by pscala           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Brain::Brain()
{
	...
	std::cout << BOLD << YELLOW << "Brain created !" << RESET << std::endl;
}
...
{
	std::cout << BOLD << YELLOW << "Brain copy asignment operator called !" << RESET << std::endl;
	if (this != &src)
	{
		for (int i = 0; i < 100; i++)
		{
