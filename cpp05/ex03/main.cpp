...
/*   Updated: 2025/04/14 18:55:31 by pscala           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	try
	{
		...
		ShrubberyForm = Steven.makeForm("ShrubberyCreationForm","home");
		RobotForm = Steven.makeForm("RobotomyRequestForm", "Jojo");
		PresidentialForm = Steven.makeForm("PresidentialPardonForm", "Gyro");
